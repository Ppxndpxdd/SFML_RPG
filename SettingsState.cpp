...
void SettingsState::initGui()
{
	...
	//Drop down lists
	this->dropDrowLists["RESOLUTION"] = new gui::DropDownList(
		gui::p2pX(41.6f, vm), gui::p2pY(41.6f, vm),
		gui::p2pX(10.4f, vm), gui::p2pY(4.6f, vm),
		font, modes_str.data(), unsigned int(modes_str.size())
	);
...
{
	/*
	* clears the GUI elements and re initaialization the GUI
	* 
	* @return void
	*/
...
void SettingsState::updateGui(const float& dt)
{
	...
	{
		//Test (remove later)
		this->stateData->gfxSettings->resolution = this->modes[this->dropDrowLists["RESOLUTION"]->getActiveElementId()];
