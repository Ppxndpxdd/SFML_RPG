...
{
	/*
	 * Converts a percentage value to pixels relative to the curent resolution in the x-axis.
	 *
...
{
	/*
	 * Converts a percentage value to pixels relative to the curent resolution in the y-axis.
	 *
	 * @param		float perc			The percentage value.
	 * @param		sf::VideoMode& vm	The current videomode of the window (resolution).
	 *
...
const unsigned gui::calcCharSize(const sf::VideoMode& vm, const unsigned modifier)
{
	 ...
	 * @param		sf::VideoMode& vm	The current videomode of the window (resolution).
	 *
	 * @param		unsigned modifier	Use to Modify the character size in more custom way.
	 *
